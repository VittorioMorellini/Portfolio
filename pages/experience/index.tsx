  ...
  return (
    ...
    <Timeline position="alternate">
      <TimelineItem>
        ...
        <TimelineContent sx={{ py: '12px', px: 2 }}>
          <Typography variant="h6" component="span">
            Novell Lan administrator and Access developer
          </Typography>
          <Typography>Experience in manufactoring</Typography>
        </TimelineContent>
      </TimelineItem>
      <TimelineItem>
        <TimelineOppositeContent
        ...
        <TimelineContent sx={{ py: '12px', px: 2 }}>
          ...
          <Typography>My target is to develop not to administer tecnology, so I started to develop</Typography>
        </TimelineContent>
      </TimelineItem>
      <TimelineItem>
        <TimelineOppositeContent
      ...
      <TimelineItem>
        ...
        <TimelineContent sx={{ py: '12px', px: 2 }}>
          <Typography variant="h6" component="span">
            My experience near home for an ambitious startup
          </Typography>
      ...
      <TimelineItem>
        ...
        <TimelineContent sx={{ py: '12px', px: 2 }}>
          <Typography variant="h6" component="span">
            Web application for Digital signature and web enterprise documental
          </Typography>
          <Typography>.Net 6, React front end developer</Typography>
        </TimelineContent>
      </TimelineItem>
    </Timeline>
    </div>
